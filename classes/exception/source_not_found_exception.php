...
/**
 * Exception thrown when source PDFs are not found
 */
class source_not_found_exception extends \moodle_exception // phpcs:ignore Squiz.Classes.ValidClassName.NotCamelCaps
{
    /**
     * Constructor
     *
