...
/**
 * Exception thrown when the backend API returns an unsuccessful response
 */
class api_response_exception extends \moodle_exception // phpcs:ignore Squiz.Classes.ValidClassName.NotCamelCaps
{
    /**
     * Constructor
     *
