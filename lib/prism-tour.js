 ...
 * Config shape:
 * {
 *   shepherdJs  : '<wwwroot>/local/arina_prism_sense/js/shepherd-tour.min.js',
 *   markSeenUrl : '<wwwroot>/local/arina_prism_sense/api/mark_tour_seen.php',
 *   sesskey     : '<moodle_sesskey>',
 *   prefKey     : 'arina_prism_sense_tour_XXX_seen',
 *   steps       : [ { id, title, text, attachTo?, buttons? }, … ],
 *   pollFor     : ['#css-selector-1', '#css-selector-2'],
 * }
 *
 * The global window.startArinaPrismSenseTour() is also exported for manual
...
(function () {
    ...
    window.startArinaPrismSenseTour = startTour;
